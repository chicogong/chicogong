<div align="center">
  ...
  <table>
    ...
    <tr>
      ...
      <td align="center">
        ...
        <img src="https://img.shields.io/badge/Go/Python-00ADD8?style=flat-square&logo=go&logoColor=white" /><br/>
        <img src="https://img.shields.io/badge/React/Next.js-61DAFB?style=flat-square&logo=react&logoColor=black" /><br/>
  ...
  <p align="center">
    <a href="https://skillicons.dev"><img src="https://skillicons.dev/icons?i=ts,js,py,go,react,next,nodejs,tailwind,mysql,postgres,redis,elasticsearch,docker,aws,gcp,cloudflare,githubactions,prometheus&perline=9" /></a>
  </p>
  
  <p align="center">
    <!-- Cloud Services that aren't in skillicons by default -->
    <img src="https://img.shields.io/badge/Tencent_Cloud-0052D9?style=flat-square&logo=tencentqq&logoColor=white" alt="Tencent Cloud" />
    <br/><br/>
    <!-- AI Tools & Platforms -->
...
- **🗣️ Voice & TTS**: Streaming ASR → LLM → TTS pipelines, prosody fine-tuning, and interruptible playback.
- **📡 Real-time**: WebRTC integration with VAD, barge-in support, and chunked synthesis.
- **Product & Agents**: Conversation-first design with memory, tool calling, and action visualization in multi-modal interactions.
- **Engineering**: Distributed task scheduling, voice dubbing platforms, and TTS ecosystem products.
...
- Low-latency voice processing optimization
- Multi-modal AI interactions (Speech + UI)
- Dialogue quality evaluation frameworks
...
<div align="center">
  <table border="0" width="100%">
    <tr border="0">
      <td width="65%" align="center" border="0" style="border: none;">
      ...
      <td width="35%" align="center" border="0" style="border: none;">
        <img src="https://github-profile-summary-cards.vercel.app/api/cards/repos-per-language?username=chicogong&theme=radical" alt="Top Languages" width="100%" />
      </td>
    </tr>
  </table>
